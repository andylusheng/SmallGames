...
export default function Page() {
  return <EsLegalPage title="Acerca de ZeroPlay Games" intro="ZeroPlay Games es un sitio de juegos HTML5 gratuitos que puedes abrir directamente en el navegador." sections={[
    { title: "Qué ofrecemos", body: ["El catálogo actual reúne 124 juegos con páginas individuales, categorías y colecciones por mecánica de juego.", "Nuestro objetivo es que la entrada al juego aparezca antes del contenido largo y que las guías describan la versión real disponible."] },
