...
export default function EsLayout({ children }: { children: React.ReactNode }) {
  ...
  const websiteJsonLd = {
    ...
    name: SITE_NAME,
    url: `${SITE_URL}/es`,
    description: "Juegos HTML5 gratis online, sin descargar ni registrarse.",
    inLanguage: "es",
    potentialAction: {
      "@type": "SearchAction",
      target: { "@type": "EntryPoint", urlTemplate: `${SITE_URL}/es/search?q={search_term_string}` },
  ...
  return (
    <html lang="es" className="dark">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-XV35XKZ474');` }} />
