...
import { MATCH_3_GAME_PROFILES } from "@/data/game-profiles/match-3";
import { LINK_CONNECT_GAME_PROFILES } from "@/data/game-profiles/link-connect";
...
const RAW_GAME_PROFILES: Record<string, GameSeoProfile> = {
  ...
  ...MATCH_3_GAME_PROFILES,
  ...LINK_CONNECT_GAME_PROFILES,
};
...
const EXPECTED_PRODUCTION_GAMES = 127;
